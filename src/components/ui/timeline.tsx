  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-5xl mb-4 font-bold tracking-tight text-white max-w-4xl">
          How It Works
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#030712] flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-blue-600/20 border border-blue-500/30 p-2" />
              </div>
